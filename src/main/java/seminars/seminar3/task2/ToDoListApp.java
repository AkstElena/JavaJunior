...
public class ToDoListApp {
    ...
    public static final String FILE_JSON = "src/main/java/seminars/seminar3/task2/tasks.json";
    public static final String FILE_BIN = "src/main/java/seminars/seminar3/task2/tasks.bin";
    public static final String FILE_XML = "src/main/java/seminars/seminar3/task2/tasks.xml";
        ...
        try {
            if (fileName.endsWith(".json")) {
                ...
                try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(fileName))) {
                    oos.writeObject(tasks); // в качестве объекта передается коллекция
                }
